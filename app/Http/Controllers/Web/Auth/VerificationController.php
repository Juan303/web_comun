...
use App\Http\Helpers\ErroresHelper;
...
class VerificationController extends Controller
{
    ...
    */
    ...
    public function verify(Request $request, $id)
    {
        ...
        session()->flash('mensaje', ['type' => 'success', 'text'=> __('E-mail verified correctly')]);
        return $request->wantsJson()
            ? new JsonResponse([], 204)
    ...
    public function resend(Request $request)
    {
        ...
        session()->flash('mensaje', ['type' => 'success', 'text'=>__('A fresh verification link has been sent to your email address.')]);
